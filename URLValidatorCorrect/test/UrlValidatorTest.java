...
protected void setUp() {
   ...
   public void testIsValid() {
        testIsValid(testUrlPartsRandom, UrlValidator.ALLOW_ALL_SCHEMES);
        setUp();
//        int options =
...
//        testIsValid(testUrlPartsOptions, options);
   ...
   private void assertEquals(String item, boolean valid, boolean result) {
...
public void testValidator202() {
   ...
   public void testIsValidRandom(Object[] testObjects, long allowAllSchemes){
	   UrlValidator urlVal = new UrlValidator(null, null, allowAllSchemes);
